                    ...
                    <div class="col-lg-10 col-xxl-10">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4>KILAS BALIK TOKO PRODUK ALN.COUTURE</h4>
                                <p class="text-muted">
                                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Atque officia quaerat error odio facilis suscipit minus repellendus ullam blanditiis dolore numquam debitis omnis voluptatum quae quam eum, modi deleniti ea.
                                </p>
                                <ul class="card-profile__info">
                                    <li class="mb-1"><strong class="text-dark mr-4">Mobile</strong> <span>085922421867
                                    </span></li>
                                    <li><strong class="text-dark mr-4">Email</strong> <span>aln.couture@gmail.com
                                    </span></li>
                                </ul>
                            </div>
                        </div>
